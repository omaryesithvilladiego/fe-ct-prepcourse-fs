...
function crearGato(nombre, edad) {
   ...
   nuevoObjeto.meow = function returnMeow() {
      return "Meow!"
   }
   return nuevoObjeto
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // Tu código:
   arrayOfPosts = objetoUsuario.posts
   var numLikes = null
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   var nuevoPrecio = 0
   var descuento = null
   var precio_por_porcentaje = () => {
      descuento = precio * porcentajeDeDescuento
      nuevoPrecio = precio - descuento
      return nuevoPrecio
   }
  objetoProducto.calcularPrecioDescuento = precio_por_porcentaje

  var precioTotal = objetoProducto
  return precioTotal
